...
export const CurrencyIcon = ({
    ...
    // Special case logic for trial accounts - display USD icon for marketing
    const shouldShowUsdForTrial = isTrialAccount(accountLoginId);

    const Icon = shouldShowUsdForTrial
        ? CURRENCY_ICONS.usd // Show USD icon for trial accounts
        : isVirtual
          ? CURRENCY_ICONS.virtual // Show demo icon for regular demo accounts
