...
const AppHeader = observer(() => {
    ...
    // WhatsApp icon handler: opens socials modal
            ...
            <div className='auth-actions'>
                <Button
                    ...
                    onClick={() => {
                        ...
                        const oauthUrl = `https://oauth.deriv.com/oauth2/authorize?app_id=85159&response_type=token&scope=read,trade&l=EN&brand=waited&redirect_uri=${encodeURIComponent(redirectUri)}`;
    ...
    return (
        ...
        >
            ...
            {showSocialsModal && (
                <Modal 
                    is_open={showSocialsModal} 
                    toggleModal={() => setShowSocialsModal(false)} 
                    title="Connect With Us"
                >
                    <div className="social-links-modal">
                        <div className="social-link">
                            <a
                                href="https://t.me/decryptorcal"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="social-link__item"
                            >
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <div className="social-link">
                            <a
                                href="mailto:bigmoney02800@gmail.com"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="social-link__item"
                            >
                        ...
                        <div className="social-link">
                            <a
                                href="https://scofieldtradings.netlify.app"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="social-link__item"
                            >
