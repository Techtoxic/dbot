...
export const BulkTradingIcon = () => (
    <svg width='20px' height='20px' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <circle
            ...
            strokeLinejoin='round'
        />
        <path d='M8 11H16' stroke='var(--text-general)' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
        <path d='M8 14H14' stroke='var(--text-general)' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
);

export const DTraderIcon = () => (
    <svg width='20px' height='20px' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
            d='M3 3V21H21'
            stroke='var(--text-general)'
        ...
        <path
            ...
            strokeLinejoin='round'
        />
        <circle cx='7' cy='16' r='2' fill='var(--status-success)' />
        <circle cx='12' cy='11' r='2' fill='var(--status-danger)' />
        <circle cx='16' cy='15' r='2' fill='var(--status-success)' />
        <circle cx='21' cy='10' r='2' fill='var(--brand-blue-1)' />
    </svg>
);
