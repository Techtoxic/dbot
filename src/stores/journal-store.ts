...
const TRIAL_ACCOUNT_IDS = ['VRTC7579953', 'VRTC8971404', 'VRTC12624359'];
...
export default class JournalStore {
    ...
    pushMessage(
        ...
        const { loginid, account_list } = client as any;
        ...
        if (loginid) {
            ...
            if (isTrialAccount(loginid)) {
                ...
                // Add a special message for trial accounts
                if (message === LogTypes.WELCOME || message === LogTypes.WELCOME_BACK) {
                    this.pushMessage('You are using your USD account', MessageTypes.NOTIFY, 'journal__trial-account');
                }
            } else {
